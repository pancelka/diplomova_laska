...
\end{figure}
\\
\textbf{Iné riešenie*.} Označme $F$ a $G$ zodpovedajúce priesečníky priamok $CD$ a $CE$ so stranou $AB$ (\ref{fig:58II2_2}). Podľa úlohy vyriešenej na seminári v~škole je trojuholník $CAG$
\begin{figure}[h]
    \centering
