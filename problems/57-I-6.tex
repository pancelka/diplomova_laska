...
\problem{57-I-6}{seminar09,cifry,domacekolo}{
...
\begin{equation} \label{eq:57I6}
    9(100a + 10b + c) = 1 000a + 100d + 10d + (a + b + c),
\end{equation}
...
Rovnosť \ref{eq:57I6} možno prepísať na tvar
\begin{equation} \label{eq:57I6_2}
...
V~prvom prípade po substitúcii $d = b - a$ upravíme vzťah~\ref{eq:57I6_2} na tvar $8c = 3(7b - 3a)$, z~ktorého vidíme, že $c$ je násobkom troch. Z~prvej tabuľky potom vyplýva $c = 3, a = 4 - b$, čo po dosadení do rovnice $8c = 3(7b - 3a)$ vedie k~riešeniu $a = b = 2, c = 3$. Pôvodné číslo je teda $x = 223$ a jeho deväťnásobok $9x = 2 007.$

V~druhom prípade dosadíme $d = b - a - 1$ do~\ref{eq:57I6_2} a zistíme, že $8c + 110 = 3(7b-3a)$. Výraz $8c+110$ je teda deliteľný tromi, preto číslo $c$ dáva po delení tromi zvyšok 2. Dosadením jediných možných hodnôt $c = 2$ a $b = 6 - a$ do poslednej rovnice zistíme, že $a = 0$, čo je v~rozpore s~tým, že číslo $x = 100a + 10b + c$ je trojciferné.
