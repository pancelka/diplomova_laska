...
\rieh Označme $\alpha, \beta, \gamma$ zvyčajným spôsobom veľkosti vnútorných uhlov trojuholníka $ABC$ \todo{doplniť (obr. 4)}. Bod $K$ leží na osi úsečky $AB$, preto $|AK| = |KB|$. Trojuholník $AKB$ je rovnoramenný so základňou $AB$, jeho vnútorné uhly pri vrcholoch $A$ a $B$ sú
