...
build-web/seminars/%.html: seminars/%.tex
	pandoc -s --mathjax=$(MATHJAX_URL) -H templates/html-header.html -B templates/html-before-body.html -A templates/html-after-body.html -f latex -t html -o $@ templates/latex-header.tex $<
