...
\problem{B-60-I-1}{seminar29,rovnice,sustavy,domacekolo}{
...
\begin{equation} \label{eq:B60I1}
    (x - z)(x + z + 1) = 0.
\end{equation}
Analogicky by sme dostali ďalšie dve rovnice, ktoré vzniknú z \ref{eq:B60I1} cyklickou zámenou neznámych $x \rightarrow y \rightarrow z$. Vzhľadom na túto symetriu (daná sústava sa nezmení dokonca pri ľubovoľnej permutácii neznámych) stačí rozobrať len nasledovné dve možnosti:
