...
\end{align*}
čiže $|AR| = |AQ| = s$. Z tejto rovnosti ale vyplýva, že $|BP| = |BR| = s - c$, čo je podľa \todo{(1)} zároveň dĺžka z úsečky $CX$, teda $|BP| = |CX|$. To znamená, že body $P$ a $X$ sú súmerne združené podľa stredu úsečky $BC$.\\
\\
\todo{DOPLNIŤ Obr. 2}\\
\\
