...
\problem{}{
Diskuze o peňěžní reformě v Tramtárii nabývala coraz větší rozměry. Mnozí její účastníci tvrdili, že návrhy z úlohy 45 se ukazují býti správnými, protože respektují i pořadí magických čísel, zatím co v úloze 46 jsou neúspěšné, protože toto pořadí nerespektovali. Jako skutočná bomba proto zapůsobil návrh, aby se vydali mince v hodnotě 4 a 11 grošů. Ani jedna hodnota se nenacházela mezi \uv{magickými} čísly!  Navzdory tomu autor tvrdil, že i tyto hodnoty splňují potřebné dvě požadavky: možno nimi vyplatit libovolné celočíselné množství grošů a když je tato suma dostatečně velká, tak ani není potřebné nic vracet. Měl pravdu?}{
}

\problem{}{
Velká diskuze ovšem odrazu skončila (právě tehdy, když byla nejživší), protože Národní banka Tramtárie na velké překvapení oznámila, že zavede dvě platitidla: tří- a pětigrošové mince. Kolika různými způsoby je možné nimi vyplatit 49 grošů bez vracení peňěz?
}{
}
