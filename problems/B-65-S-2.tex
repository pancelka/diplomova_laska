...
\problem{B-65-S-2}{seminar32,geompoc,skolskekolo}{
...
\rieh Body $D$ aj $F$ ležia na kružnici $m$ so stredom $B$, takže trojuholník $BDF$ je rovnoramenný a platí $|\ma BFK| = |\ma BDF| > 45^\circ$, pretože trojuholník $BDF$ je navyše ostrouhlý \todo{(obr. 1)}. To ale znamená, že bod $K$ musí ležať v polrovine $oA$, pričom $o$ je os úsečky $AB$, pretože oblúk $BK$ prislúcha obvodovému uhlu väčšiemu ako $45^\circ$.
