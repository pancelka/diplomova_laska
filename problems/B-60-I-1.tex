...
$$(x - z)(x + z + 1) = 0. \ \ \ \ (1)$$
Analogicky by sme dostali ďalšie dve rovnice, ktoré vzniknú z \todo{fixni(1)} cyklickou zámenou neznámych $x \rightarrow y \rightarrow z$. Vzhľadom na túto symetriu (daná sústava sa nezmení dokonca pri ľubovoľnej permutácii neznámych) stačí rozobrať len nasledovné dve možnosti:
