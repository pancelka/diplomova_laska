...
$$z^2 + 2(a + 1)^2 = 0. \ \ \ \  (2)$$
Oba sčítance na ľavej strane poslednej rovnice sú nezáporné čísla. Ich súčet je 0 práve vtedy, keď $z = 0$, $a = -1$. Dosadením týchto hodnôt do \todo{(1)} dostaneme $x = 0, y = 1$.
