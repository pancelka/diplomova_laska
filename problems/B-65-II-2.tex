...
\todo{DOPLNIŤ Obr. 1}\\
\\
na polomer $BF$ kružnice $m$, a preto sa priamka $AF$ dotýka kružnice $m$ v bode $F$ \todo{(obr. 1)}. Z rovnosti úsekového uhla zovretého tetivou $DF$ s dotyčnicou $AF$ a obvodového uhla
...
\textbf{Iné riešenie*.} Nad oblúkom $AE$ kružnice $k$ sa zhodujú uhly $ABE$ a $AFE$ \todo{(obr. 2)}. Oblúku $DE$ kružnice $m$ prislúcha obvodový uhol $DFE$ a stredový uhol $DBE$. Spolu
tak dostávame
